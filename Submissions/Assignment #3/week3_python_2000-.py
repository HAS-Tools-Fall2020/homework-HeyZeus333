...
for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 8 and 23 <= day[i] <= 29:
                week1.append(flow[i])

week2= []
for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 8 and 30 <= day[i] <= 31:
                week2.append(flow[i])
for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 9 and 0 <= day[i] <= 5:
                week2.append(flow[i])

week3 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 9 and 6 <= day[i] <= 12:
                week3.append(flow[i])

week4 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 9 and 13 <= day[i] <= 19:
                week4.append(flow[i])

week5 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 9 and 20 <= day[i] <= 26:
                week5.append(flow[i])

week6 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 9 and 27 <= day[i] <= 31:
                week6.append(flow[i])
for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 10 and 0 <= day[i] <= 3:
                week6.append(flow[i])

week7 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 10 and 4 <= day[i] <= 10:
                week7.append(flow[i])

week8 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 10 and 11 <= day[i] <= 17:
                week8.append(flow[i])

week9 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 10 and 18 <= day[i] <= 24:
                week9.append(flow[i])

week10 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 10 and 25 <= day[i] <= 31:
                week10.append(flow[i])

week11 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 11 and 0 <= day[i] <= 7:
                week11.append(flow[i])

week12 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 11 and 8 <= day[i] <= 14:
                week12.append(flow[i])

week13 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 11 and 15 <= day[i] <= 21:
                week13.append(flow[i])

week14 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 11 and 22 <= day[i] <= 28:
                week14.append(flow[i])

week15 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 11 and 29 <= day[i] <= 31:
                week15.append(flow[i])
for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 12 and 0 <= day[i] <= 5:
                week15.append(flow[i])

week16 = []

for i in range(len(flow)):
        if flow[i] <=600 and year[i] <= 2000 and month[i] == 12 and 6 <= day[i] <= 12:
...
plt.ylabel('Flow (cfs)');
plt.ylim([0, 250])
plt.title('Weekly Discharge Pre-2000');
plt.legend()
plt.savefig('Discharge_Pre-2000.png')
#%%
weeklyprediction= []
for i in range(0,8):
...
plt.legend()
plt.savefig('Discharge_prediction_2000-.png')

# %%
# number of times greater than prediction
week_2= []
for i in range(len(flow)):
        if  flow[i] > weeklyprediction[1] and month[i] == 8 and 30 <= day[i] <= 31:
                week_2.append(flow[i])
for i in range(len(flow)):
        if  flow[i] > weeklyprediction [1] and month[i] == 9 and 0 <= day[i] <= 5:
                week_2.append(flow[i])

week_3 = []

for i in range(len(flow)):
        if flow[i] > weeklyprediction [2] and month[i] == 9 and 6 <= day[i] <= 12:
                week_3.append(flow[i])

week_4 = []

for i in range(len(flow)):
        if  flow[i] > weeklyprediction [3] and month[i] == 9 and 13 <= day[i] <= 19:
                week_4.append(flow[i])

week_5 = []

for i in range(len(flow)):
        if  flow[i] > weeklyprediction [4] and month[i] == 9 and 20 <= day[i] <= 26:
                week_5.append(flow[i])
...
l_week_2= []
for i in range(len(flow)):
        if  flow[i] > 0 and month[i] == 8 and 30 <= day[i] <= 31:
                l_week_2.append(flow[i])
for i in range(len(flow)):
        if  flow[i] > 0 and month[i] == 9 and 0 <= day[i] <= 5:
                l_week_2.append(flow[i])

l_week_3 = []

for i in range(len(flow)):
        if flow[i] > 0 and month[i] == 9 and 6 <= day[i] <= 12:
                l_week_3.append(flow[i])

l_week_4 = []

for i in range(len(flow)):
        if  flow[i] > 0 and month[i] == 9 and 13 <= day[i] <= 19:
                l_week_4.append(flow[i])

l_week_5 = []

for i in range(len(flow)):
        if  flow[i] > 0 and month[i] == 9 and 20 <= day[i] <= 26:
                l_week_5.append(flow[i])

# %%
print(len(week_2)/len(l_week_2))
print(len(week_3)/len(l_week_3))
print(len(week_4)/len(l_week_4))
print(len(week_5)/len(l_week_5))
