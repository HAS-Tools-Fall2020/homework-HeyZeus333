...
# data['flow'] = stats.trim1(data['flow'], proportiontocut=0.2, tail='right')
# Aggregate flow values to weekly 
flow_weekly = data.resample("W", on='datetime').mean()
#%%
# data_to_plot = [data.flow]
...
#%%
# flow_weekly = flow_weekly[flow_weekly.flow <= 500]
...
#%%
# print(data2["1"].dropna())
# #%%
# data_to_plot = [data2['1'].dropna(), data2['2'].dropna(), data2['3'].dropna(), data2['4'].dropna(), data2['5'].dropna(), data2['6'].dropna(), data2['7'].dropna(), data2['8'].dropna(), data2['9'].dropna(), data2['10'].dropna(), data2['11'].dropna(), data2['12'].dropna()]
